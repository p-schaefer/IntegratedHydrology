...
# The function can be run repeatedly with additional points, so long as the `site_id_col`
# is consistent, and new points don't overlap existing points
...
hydro_out_sparse<-process_hydrology(
  ...
  snap_distance=NULL, # 250L,
  site_id_col=NULL, # "site_id",
  pwise_dist=T,
  return_products=F,
  temp_dir=NULL,
  verbose=F
