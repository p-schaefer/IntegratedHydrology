...
The `fasttrib_points()` function is a bit less flexible in its inputs, but is considerably for larger data sets, more loi, and more sampling points. For small datasets `attrib_points()` may be faster.
